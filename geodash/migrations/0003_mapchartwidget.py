# Generated by Django 4.2.8 on 2024-02-14 10:52
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('geodash', '0002_mapwidget_raster_file_layer_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='geomanager.dataset')),
                ...
                ('raster_file_layer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='geomanager.rasterfilelayer')),
            ],
            options={
                'abstract': False,
            },
